...
private:
    int _dimension;
public:
    VestibularAccelerationChannel(std::string name, int dimension);
    VestibularAccelerationChannel(std::string name, int dimension, device::channel::Normalizer* normalizer, device::Device* device);
