...
DRobotVision::DRobotVision( )
{
	...
	lp = new cv::LogPolar_Adjacent(FRAME_WIDTH, FRAME_HEIGHT, cv::Point2i(FRAME_WIDTH/2, FRAME_HEIGHT/2)); //, 50, 3, 0.25, 1, 70, 0);
...
DRobotVision::applyTransforms( )
{
	...
	resize(frameLPCartesian, frameLPCartesian, cv::Size(FRAME_WIDTH*2, FRAME_HEIGHT*2));
...
double
DRobotVision::getTDPixelActivity()
{
