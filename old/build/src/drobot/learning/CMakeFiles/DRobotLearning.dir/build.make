...
src/drobot/learning/libDRobotLearning.so: /usr/local/lib/libopencv_calib3d.so
src/drobot/learning/libDRobotLearning.so: /usr/local/lib/libopencv_contrib.so
src/drobot/learning/libDRobotLearning.so: /usr/local/lib/libopencv_core.so
src/drobot/learning/libDRobotLearning.so: /usr/local/lib/libopencv_features2d.so
src/drobot/learning/libDRobotLearning.so: /usr/local/lib/libopencv_flann.so
src/drobot/learning/libDRobotLearning.so: /usr/local/lib/libopencv_gpu.so
src/drobot/learning/libDRobotLearning.so: /usr/local/lib/libopencv_highgui.so
src/drobot/learning/libDRobotLearning.so: /usr/local/lib/libopencv_imgproc.so
src/drobot/learning/libDRobotLearning.so: /usr/local/lib/libopencv_legacy.so
src/drobot/learning/libDRobotLearning.so: /usr/local/lib/libopencv_ml.so
src/drobot/learning/libDRobotLearning.so: /usr/local/lib/libopencv_nonfree.so
src/drobot/learning/libDRobotLearning.so: /usr/local/lib/libopencv_objdetect.so
src/drobot/learning/libDRobotLearning.so: /usr/local/lib/libopencv_photo.so
src/drobot/learning/libDRobotLearning.so: /usr/local/lib/libopencv_stitching.so
src/drobot/learning/libDRobotLearning.so: /usr/local/lib/libopencv_superres.so
src/drobot/learning/libDRobotLearning.so: /usr/local/lib/libopencv_ts.so
src/drobot/learning/libDRobotLearning.so: /usr/local/lib/libopencv_video.so
src/drobot/learning/libDRobotLearning.so: /usr/local/lib/libopencv_videostab.so
